 ...
 *******************************************************************************/
package org.eclipse.leshan.mtserver.demo;
...
import org.eclipse.leshan.mtserver.demo.servlet.ServerServlet;
...
public class LeshanMultitierDemo {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LeshanMultitierDemo.class);
    ...
    public static void main(String[] args) {
        ...
        // Parse command line
        LeshanMultiTierDemoCLI cli = new LeshanMultiTierDemoCLI();
    ...
    public static LeshanServer createLeshanServer(LeshanMultiTierDemoCLI cli) throws Exception {
    ...
    private static Server createJettyServer(LeshanMultiTierDemoCLI cli, LeshanServer lwServer) throws IOException {
        // Now prepare Jetty
        ...
        root.setContextPath("/");
        root.setResourceBase(LeshanMultitierDemo.class.getClassLoader().getResource("webapp").toExternalForm());
